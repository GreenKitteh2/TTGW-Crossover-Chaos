...
func _init():
	...
	GameLoader.queue_into(GameLoader.Phase.GAME_START, self, {
		...
		'MANAGER_COG_POOL': 'res://objects/cog/presets/pools/managers.tres',
		'ALL_COG_POOL': 'res://objects/cog/presets/pools/everybody.tres',
		'MOD_COG_POOL': 'res://objects/cog/presets/pools/mod_cogs.tres',
		'CROSSOVER_COG_POOL': 'res://objects/cog/presets/pools/crossover_cogs.tres',
		'INTERN_COG_POOL': 'res://objects/cog/presets/pools/interns.tres',
		'ELITE_COG_POOL': 'res://objects/cog/presets/pools/elites.tres',
		'OMNIPOTENT_COG_POOL': 'res://objects/cog/presets/pools/omnipotents.tres',
		'BOSS_COG_POOL': 'res://objects/cog/presets/pools/crossover_bosses.tres',
		'ALL_COGS_POOL': 'res://objects/cog/presets/pools/all_cogs.tres',
		'Muffet_Cog': 'res://objects/cog/presets/pools/muffet.tres',
	})
	...
	GameLoader.queue_into(GameLoader.Phase.GAMEPLAY, self, {
		...
		'steel_factory_floor_variant': 'res://scenes/game_floor/floor_variants/base_floors/steel_factory.tres',
		'bullion_mint_floor_variant': 'res://scenes/game_floor/floor_variants/base_floors/bullion_mint.tres',
		'senior_wing_floor_variant': 'res://scenes/game_floor/floor_variants/base_floors/senior_wing.tres',
		'final_fringe_floor_variant': 'res://scenes/game_floor/floor_variants/base_floors/final_fringe.tres',
		'molten_floor_variant': 'res://scenes/game_floor/floor_variants/alt_floors/molten_mint.tres',
		'demented_floor_variant': 'res://scenes/game_floor/floor_variants/base_floors/dementia_facility.tres',
	})
...
var ADDITIONAL_TOON_PATHS := [
	...
	'res://objects/player/characters/peppino.tres',
	'res://objects/player/characters/frisk.tres',
	'res://objects/player/characters/chara.tres',
	'res://objects/player/characters/admin.tres',
	'res://objects/player/characters/lovealot.tres',
	'res://objects/player/characters/buck.tres',
]
...
var MANAGER_COG_POOL: CogPool
var ALL_COG_POOL: CogPool
var MOD_COG_POOL: CogPool
var CROSSOVER_COG_POOL: CogPool
var INTERN_COG_POOL: CogPool
var ELITE_COG_POOL: CogPool
var OMNIPOTENT_COG_POOL: CogPool
var BOSS_COG_POOL: CogPool
var Muffet_Cog: CogPool

func add_standard_cog(cog_dna: CogDNA) -> void:
	GRUNT_COG_POOL.cogs.append(cog_dna)
	ALL_COG_POOL.cogs.append(cog_dna)

func remove_standard_cog(cog_dna: CogDNA) -> void:
	GRUNT_COG_POOL.cogs.erase(cog_dna)
	ALL_COG_POOL.cogs.erase(cog_dna)

func add_crossover_cog(cog_dna: CogDNA) -> void:
	CROSSOVER_COG_POOL.cogs.append(cog_dna)

func remove_crossover_cog(cog_dna: CogDNA) -> void:
	CROSSOVER_COG_POOL.cogs.erase(cog_dna)
...
var MANAGER_CHANCE_MAXIMUM := 0.5
var CROSSOVER_CHANCE_MAXIMUM := 0.75
...
var steel_factory_floor_variant: FloorVariant
var bullion_mint_floor_variant: FloorVariant
var senior_wing_floor_variant: FloorVariant
var final_fringe_floor_variant: FloorVariant
var molten_floor_variant: FloorVariant # Not added to FLOOR_VARIANTS as it's an alt floor
var demented_floor_variant: FloorVariant
...
var FLOOR_VARIANTS: Array[FloorVariant]:
	get:
		var variants: Array[FloorVariant] = [
			...
			da_floor_variant,
			cgc_floor_variant,
			steel_factory_floor_variant,
			bullion_mint_floor_variant,
			senior_wing_floor_variant,
			final_fringe_floor_variant,
			demented_floor_variant,
		]
...
var custom_seeds: Dictionary[String, Variant] = {
	...
	# Have fun fighting other fandoms boi
	"fandommenace": "res://objects/items/resources/custom_seeds/seed_crossover.tres",
	
	# Genocide route
	"toughcrowd": "res://objects/items/resources/custom_seeds/seed_extra_cogs.tres",
	
	# Try it :3
	"ihatespiders": "res://objects/items/resources/custom_seeds/seed_muffet.tres",
	
	# 2013 missed calls from TTR
	"tooeasy": "res://objects/items/resources/custom_seeds/seed_hard_mode.tres",
	...
	# Don't...ever...
	"getfixedboi": [
		"res://objects/items/resources/custom_seeds/seed_zenith.tres",
		"res://objects/items/resources/custom_seeds/seed_extra_cogs.tres",
		"res://objects/items/resources/custom_seeds/seed_crossover.tres"
	],
