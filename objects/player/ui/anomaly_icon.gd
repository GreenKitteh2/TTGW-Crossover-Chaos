...
const QualityColors := {
	FloorModifier.ModType.SUPERPOSITIVE: Color(0.487, 1.0, 0.46, 1.0),
	FloorModifier.ModType.POSITIVE: Color(0.0, 0.823, 0.0, 1.0),
	FloorModifier.ModType.NEUTRAL: Color("5190ff"),
	FloorModifier.ModType.NEGATIVE: Color(1, 0.336, 0.27),
	FloorModifier.ModType.SUPERNEGATIVE: Color(0.501, 0.0, 0.0, 1.0),
}
