...
@export var crossover_chance_boost = 0.0
@export var manager_chance_boost = 0.0
@export var elite_chance_boost := 0.0
@export var omnipotent_chance_boost := 0.0
@export var boss_cog_chance_boost := 0.0
