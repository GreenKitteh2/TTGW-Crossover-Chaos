...
const FORWARD_THINKING_REFERENCE := preload("res://objects/battle/battle_resources/status_effects/resources/status_effect_forward_thinking.tres")
...
func apply_boost(cog : Cog) -> void:
	var new_boost := FORWARD_THINKING_REFERENCE.duplicate(true)
