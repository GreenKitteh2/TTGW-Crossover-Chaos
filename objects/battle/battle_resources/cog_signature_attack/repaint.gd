...
const PHRASES := [
	"This should give you a better light.",
	"Make this is a good fit for you.",
	"Hold still, I don't want to make it messy.",
	"You need a better palette.",
]
...
func action() -> void:
	...
	manager.show_action_name("Repaint!", "Gives a Lure Immunity!")
