...
static var ANOMALIES_SUPERPOSITIVE: Array[String] = [
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_fragile.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_cheerful.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_low_health.gd",
]
...
static var ANOMALIES_POSITIVE: Array[String] = [
	...
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_brittle.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_flimsy.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_strong.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_rusty.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_damaged.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_head_hit.gd",
]
static var ANOMALIES_NEUTRAL: Array[String] = [
	...
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_skeleton.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_virtual.gd"
]
static var ANOMALIES_NEGATIVE: Array[String] = [
	...
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_distress.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_brute.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_weak.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_improved.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_extra_cog.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_overvalue.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_executive.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_crossover.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_overhealed.gd",
]

static var ANOMALIES_SUPERNEGATIVE: Array[String] = [
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_two_extra_cog.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_triple_threat.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_second_skin.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_low_esteam.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_crossover_invasion.gd",
	"res://scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_overcharged.gd",
]
...
func get_anomalies() -> Array[Script]:
	...
	var anomaly_files_suppos: Array[String] = ANOMALIES_SUPERPOSITIVE.duplicate(true)
	...
	var anomaly_files_supneg: Array[String] = ANOMALIES_SUPERNEGATIVE.duplicate(true)
	...
	for i in mod_count:
		...
		# Super Positive anomalies
		if rng_val <= 0.20:
			mod_array = anomaly_files_suppos
			if mod_array.size() == 0:
				mod_array = RNG.channel(RNG.ChannelFloorMods).pick_random([anomaly_files_pos, anomaly_files_neutral, anomaly_files_neg, anomaly_files_supneg])
		# Positive anomalies
		elif rng_val <= 0.40:
			mod_array = anomaly_files_pos
			if mod_array.size() == 0:
				mod_array = RNG.channel(RNG.ChannelFloorMods).pick_random([anomaly_files_suppos, anomaly_files_neutral, anomaly_files_neg, anomaly_files_supneg])
		# Neutral anomalies
		elif rng_val <= 0.60:
			mod_array = anomaly_files_neutral
			if mod_array.size() == 0:
				mod_array = RNG.channel(RNG.ChannelFloorMods).pick_random([anomaly_files_suppos, anomaly_files_pos, anomaly_files_neg, anomaly_files_supneg])
		# Negative anomalies		
		elif rng_val <= 0.80:
			...
			if mod_array.size() == 0:
				mod_array = RNG.channel(RNG.ChannelFloorMods).pick_random([anomaly_files_suppos, anomaly_files_pos, anomaly_files_neg, anomaly_files_supneg])		
		# Super Negative anomalies
		else:
			if no_negative_anomalies:
				continue

			mod_array = anomaly_files_supneg
			if mod_array.size() == 0:
				mod_array = RNG.channel(RNG.ChannelFloorMods).pick_random([anomaly_files_suppos, anomaly_files_pos, anomaly_files_neutral, anomaly_files_neg])
...
func get_new_anomaly() -> Script:
	...
	possible_anomalies.append_array(ANOMALIES_SUPERPOSITIVE)
